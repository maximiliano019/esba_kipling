...
<body>
            <h1 class="alert-success">  Administrar Password del usuario <?php echo $usuario->nombre ?> </h1>

   <div class="container py-4">
       <?php
            if ($usuario->id == $SessionData->id){
        ?>
       <form method="POST">
            ...
            <div class="form-group py-2">
                ...
                <input type="password" name="password" class="form-control" id="password" placeholder="password" value="<?php echo $usuario->password; ?>">
            </div>
            <div class="py-2">
       ...
       <?php
        ...
        ?>
                <h2> UD ESTA INTENTANDO EDITAR UN USUARIO QUE NO ES UD. POR FAVOR VUELVA A LA LISTA DE USUARIOS</h2>
        <?php
        }
       ?>
    </div>
